...
public class Solution implements Runnable {
    ...
    public void solve() {
        ...
        for (int i = 0; i < numberOfTables; i++) {
            ...
            //map tables name with corresponding index in hashmap
    ...
    /**
     * This method is used to join the two tables given from parameter and query
     * line
     *
     ...
     * @return void This dosent return anything, joins the tables and calls
     * printResult() to display output
     */
